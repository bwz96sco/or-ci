...
{"file": "$DIR_WORKFLOW/$DIR_SPEC/guides/index.md", "reason": "Shared thinking guides"}
EOF
}
...
{"file": "$DIR_WORKFLOW/$DIR_SPEC/backend/directory-structure.md", "reason": "Backend directory conventions"}
{"file": "$DIR_WORKFLOW/$DIR_SPEC/backend/quality-guidelines.md", "reason": "Code quality requirements"}
EOF
}
...
{"file": "$DIR_WORKFLOW/$DIR_SPEC/frontend/component-guidelines.md", "reason": "Component conventions"}
EOF
}
...
get_debug_context() {
  ...
  echo "{\"file\": \"$DIR_WORKFLOW/$DIR_SPEC/guides/index.md\", \"reason\": \"Shared thinking guides\"}"
